...
class Midnight extends Document {
    ...
    return (
      <Html lang="en">
        <Head>
          ...
          <meta property="og:url" content="http://dashboard.midnightbot.tk:30352" />
          ...
          <meta
            ...
            content={`🤖 ${process.env["NEXT_PUBLIC_DASHBOARD_BOTNAME"]} is a feature-rich Discord bot with +200 commands for Discord servers. Economy, util, fun, music, admin and more! Built with Next.js and Discord.js`}
          />
          <meta property="og:image" content="http://dashboard.midnighbot.tk:30352/banner.png" />

          {/* <!-- Twitter Meta Tags --> */}
          <meta name="twitter:card" content="summary_large_image" />
          <meta property="twitter:domain" content="dashboard.midnightbot.tk:30352" />
          <meta property="twitter:url" content="http://dashboard.midnightbot.tk:30352" />
          <meta
            name="twitter:title"
            content={`${process.env["NEXT_PUBLIC_DASHBOARD_BOTNAME"]} - A Discord bot`}
          />
          <meta name="twitter:image" content="http://dashboard.midnighbot.tk:30352/banner.png" />
          <meta
