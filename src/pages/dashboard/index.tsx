  ...
  return (
    <>
      <AlertMessage
        message={
          <>
            {t("beta")} <a href="https://discord.gg/kAFm2aQDNj">https://discord.gg/kAFm2aQDNj</a>
          </>
        }
      />
              ...
              >
                {guild.icon === null ? (
                  ...
                  <Image
                    ...
                    src={`https://cdn.discordapp.com/icons/${guild.id}/${guild.icon}.${guild.icon.startsWith("a_") ? "gif" : "webp"
                      }`}
                    width="65"
                    height="65"
                  />
